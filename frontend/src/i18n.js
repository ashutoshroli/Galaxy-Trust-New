...
export const translations = {
  en: {
    ...
    'login.forgotHint': 'Enter your account email and we\u2019ll send you a link to reset your password.',
  ...
  hi: {
    ...
    'login.forgotHint': 'अपना खाता ईमेल दर्ज करें, हम आपको पासवर्ड रीसेट करने के लिए एक लिंक भेजेंगे।',
